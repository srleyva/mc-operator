module github.com/sleyva/minecraft-operator
...
require (
	...
	github.com/aws/aws-k8s-tester v1.0.0 // indirect
	...
	github.com/tektoncd/pipeline v0.11.3 // indirect
	...
	istio.io/client-go v0.0.0-20200513000250-b1d6e9886b7b // indirect
	k8s.io/api v0.20.0
